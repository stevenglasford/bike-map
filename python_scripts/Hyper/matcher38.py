...
class VideoValidator:
        ...
        with tqdm(video_files, desc="Validating videos", unit="video") as pbar:
            for video_path in pbar:
                try:
                    ...
                    corrupted_videos.append(video_path)
                    validation_details[video_path] = {'is_valid': False, 'error': str(e)}
    ...
    def _validate_single_video(self, video_path):
    ...
    def _check_video_header(self, video_path):
    ...
    def _ffprobe_validation(self, video_path):
    ...
    def _quarantine_video(self, video_path, error_reason):
    ...
    def _print_validation_summary(self, valid_videos, corrupted_videos, validation_details):
